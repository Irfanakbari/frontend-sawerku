...
const Sawer = (props) => {
  ...
  useEffect(() => {
    axios
      .get("https://backend1.irfans.me/v1/users/" + router.query.username)
      .then((res) => {
  ...
  const submitHandler = async (e) => {
    ...
    if (e == "qris") {
      ...
      try {
        const respon = await axios.post(
          "https://backend1.irfans.me/v1/payments/xendit/" + username,
          {
            email: sawer.email,
            nominal: parseInt(nominal),
            from: sawer.dari,
                    ...
                    <div className="grid grid-cols-4 gap-2 w-full justify-center">
                      <div className="col-span-1">
                        <div
                          ...
                          className="w-full btn bg-orange-400 hover:bg-orange-500 border-2 border-black text-white font-semibold font-zillaSlabMedium text-xl py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                        >
                          10k
                        </div>
                      </div>
                      <div className="col-span-1 ">
                        <div
                          ...
                          className="bg-yellow-400 btn w-full hover:bg-yellow-500 border-2 border-black text-white font-semibold font-zillaSlabMedium text-xl py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                        >
                          25k
                        </div>
                      </div>
                      <div className="col-span-1">
                        <div
                          ...
                          className="bg-blue-400 btn w-full hover:bg-blue-500 border-2 border-black text-white font-semibold font-zillaSlabMedium text-xl py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                        >
                          50k
                        </div>
                      </div>
        ...
        <>
          <div className="flex h-screen justify-center items-center">
            <div className="text-cente">
              <h1 className="text-[40px] font-zillaSlabSemiBold">
                Username ini tidak ditemukan
              </h1>
            </div>
          </div>
        </>
