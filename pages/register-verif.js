...
const Login = (props) => {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        setLoading(true);
        postAPI("https://backend-sawerku.herokuapp.com/v1/auth/register", {
                    ...
                    <div className="max-w-lg mx-auto font-inter p-4">
                        <form onSubmit={submitHandler}>
                            ...
                            <label>
                                ...
                                ></input>
                                {
                                    isUsername ? <span className="block text-red-500 text-sm text-left mt-2">Username Sudah Terpakai</span> : null
                                }
                            </label>
                            <br />
                            <label>
